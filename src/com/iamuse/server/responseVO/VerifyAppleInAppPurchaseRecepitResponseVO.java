...
public class VerifyAppleInAppPurchaseRecepitResponseVO {
	...
	public String toString() {
		return "VerifyAppleInAppPurchaseRecepitResponseVO [product_id="
				+ product_id + ", original_purchase_date_ms="
				+ original_purchase_date_ms + ", purchase_date_pst="
				+ purchase_date_pst + ", original_purchase_date="
				+ original_purchase_date + ", bvrs=" + bvrs
				+ ", transaction_id=" + transaction_id
				+ ", original_purchase_date_pst=" + original_purchase_date_pst
				+ ", unique_identifier=" + unique_identifier
				+ ", original_transaction_id=" + original_transaction_id
				+ ", item_id=" + item_id + ", purchase_date_ms="
				+ purchase_date_ms + ", quantity=" + quantity
				+ ", purchase_date=" + purchase_date + ", bid=" + bid
